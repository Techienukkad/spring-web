...
<body onload='document.f.username.focus();'>
	...
	<div class="limiter">
		<div class="container-login100">
			...
			<p style="font: 300;color: red;align-content: center;" align="center">Something wrong with username or password</p>
			</c:if>
				<c:if test="${requestScope.created !=null}">
			<p style="font: 300;color: green;" align="center">Account Created ! Login with your Credentials</p>
			</c:if>
